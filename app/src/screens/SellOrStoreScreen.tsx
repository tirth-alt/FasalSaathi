  ...
  return (
    <View style={{ gap: 18, paddingBottom: 24 }}>
      <View style={{ gap: 4, paddingTop: 4 }}>
        ...
        <Text style={{ fontSize: 14, color: colors.muted }}>The honest math, your decision</Text>
      </View>
      ...
      <Card>
        <View style={{ gap: 4, paddingBottom: 8 }}>
          ...
          <Text style={{ fontSize: 13, color: colors.muted }}>A calculation, not a prediction</Text>
        </View>
      ...
      <Card>
        <View style={{ gap: 10 }}>
          <Text style={{ fontSize: 17, fontWeight: '800', color: colors.ink }}>Need cash now?</Text>
          <View
            style={{
              flexDirection: 'row',
              alignItems: 'center',
          ...
          >
            <View style={{ gap: 2 }}>
              <Text style={{ fontSize: 13, color: colors.up, fontWeight: '700' }}>Pledge loan (eNWR, 70%)</Text>
              <Text style={{ fontSize: 26, fontWeight: '900', color: colors.up }}>₹16,275</Text>
            </View>
          </View>
